...
- 完成章節獎勵
- 金句、劃記與「我的亮光」互動
- 490 題首批題庫，完整涵蓋 `測驗卷主題.txt` 的 98 個分卷範圍
- 可實際作答的單卷／分卷、綜合與主題測驗，附答案解說與經文出處
- 角色等級、經驗值及代幣摘要
- Google 帳號登入與跨裝置永久資料同步
- 管理員帳號後台、使用者刪除與題庫新增／修改／停用／刪除功能
...
題庫依 `測驗卷主題.txt` 與本地 CUVt 經文產生。`npm run quiz:generate` 可重建題庫資料與種子 SQL；正式題目仍可由管理員後台逐題校訂。
